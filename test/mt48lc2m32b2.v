/**************************************************************************
*
* MODIFIED TO MATCH DS226-2.1.2E DATASHEET FOR GOWIN GW2AR FPGA
* USING TIMINGS FROM MT48LC2M32B2 DATASHEET FOR CL3 6A PART
*
...
module mt48lc2m32b2 (Dq, Dq_o, Addr, Ba, Clk, Cke, Cs_n, Ras_n, Cas_n, We_n, Dqm);
        ...
        if (Active_enable === 1'b1) begin
            ...
            if (Ba === 2'b00 && Pc_b0 === 1'b1) begin
                ...
                if ($time - RP_chk0 < tRP) begin
                    $display ("%m : at time %t ERROR: tRP violation during Activate bank 0 expected = %d actual = %d", $time, tRP, $time - RP_chk0);
                end
